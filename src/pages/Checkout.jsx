...
export default function Checkout() {
  ...
  useEffect(() => {
    setPageSeo({
      ...
      description: 'ثبت سفارش گل‌های ماندگار نیلا گل — پرداخت درب منزل در گرگان و ارسال پستی به سراسر کشور.',
    });
    return () => resetPageSeo();
  }, []);
        ...
        <div className="container">
          <div className="checkout-success glass">
            ...
            <p className="checkout-success-text">
              ...
              در ارتباط خواهیم بود. پرداخت در گرگان درب منزل و برای سایر شهرها ارسال پستی انجام می‌شود.
            </p>
